...
public class LossList extends AppCompatActivity {

    private RecyclerView recyclerView;
    private LossAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.loss_list);

        recyclerView = findViewById(R.id.stock_list_loss);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        stockList = new ArrayList<>();
        adapter = new LossAdapter(stockList);
        recyclerView.setAdapter(adapter);

        databaseReference = FirebaseDatabase.getInstance().getReference("TopLosers");
